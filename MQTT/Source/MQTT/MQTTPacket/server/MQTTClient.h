...
#define MutexInit(X) 		pthread_mutex_init(X, NULL)
...
#define ThreadStart(a,b,c) 	pthread_create(a, NULL,b,c)
#define ThreadEnd() 		pthread_exit(NULL)
 ...
 *  @return success code
 */
DLLExport int MQTTPublish(MQTTClient* c, const char* topicName, MQTTMessage* message);
