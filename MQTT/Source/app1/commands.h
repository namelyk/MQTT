...
/******************防拆功能*******************/
//防拆设置
#define READ_SECU_ENABLE_CMD			0x1364
#define READ_SECU_ENABLE_ACK			0x1365

#define SET_SECU_ENABLE_CMD				0X1366
#define SET_SECU_ENABLE_ACK				0X1367

//防拆目标 
#define READ_SECU_TARGET_CMD			0x1368
#define READ_SECU_TARGET_ACK			0x1369

#define SET_SECU_TARGET_CMD				0X136A
#define SET_SECU_TARGET_ACK				0X136B

//防拆校准
#define READ_ADC_REFVDD_CMD				0x136C
#define READ_ADC_REFVDD_ACK				0x136D
